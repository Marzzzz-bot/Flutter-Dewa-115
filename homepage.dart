...
class _MyHomePageState extends State<MyHomePage> {
  List<Barang> barangList = [
    Barang(id: 'B001', nama: 'Beras', stok: 100, harga: 12000),
    Barang(id: 'B002', nama: 'Gula', stok: 50, harga: 14000),
                        ...
                        _buildFeatureCard(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => BarangKeluarPage(
                                  barangList: barangList,
                                  transaksiList: transaksiList,
                                  onBarangKeluar: _kurangiBarangKeluar,
                                ),
                              ),
                            );
                          },
                        ...
                        _buildFeatureCard(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    BarangPage(barangList: barangList),
                              ),
                            );
                          },
                        ),
